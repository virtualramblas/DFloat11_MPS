...
def main(model_id, num_tokens, temperature, prompt):
    ...
    outputs = model.generate(**inputs, max_length=num_tokens, temperature=temperature)
...
if __name__ == '__main__':
    ...
    main(args.model_id, args.num_tokens, args.temperature, args.prompt)